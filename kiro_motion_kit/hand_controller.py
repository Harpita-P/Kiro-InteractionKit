...
from .hand_gestures import is_hand_closed, is_pinch_gesture, is_peace_sign, is_thumbs_up, is_thumbs_down, is_rock_sign, is_open_hand, is_pointing, is_ok_sign
...
class HandTracker:
    ...
    def process_frame(self, frame_bgr):
        ...
        if results.multi_hand_landmarks:
            ...
            # kiro_motion_kit.hand_gestures so new gestures can be added easily.
