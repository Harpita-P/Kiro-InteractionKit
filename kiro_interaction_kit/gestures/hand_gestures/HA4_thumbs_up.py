def is_thumbs_up(landmarks, curl_threshold: float = 0.05) -> bool:
    """Return True if the hand forms a thumbs up gesture.
    
    Heuristic:
    - Thumb (4) is extended upward (higher than hand center)
